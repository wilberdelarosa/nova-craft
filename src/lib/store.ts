...
const sampleProducts: Product[] = [
  {
    ...
    variants: [
      { id: 'v1', productId: '1', variantSku: 'CAM-OXF-001-S-AZ', size: 'S', color: 'Azul', barcode: 'RD20240001', stock: 8, minStock: 3, active: true },
      { id: 'v2', productId: '1', variantSku: 'CAM-OXF-001-M-AZ', size: 'M', color: 'Azul', barcode: 'RD20240002', stock: 12, minStock: 3, active: true },
      { id: 'v3', productId: '1', variantSku: 'CAM-OXF-001-L-AZ', size: 'L', color: 'Azul', barcode: 'RD20240003', stock: 5, minStock: 3, active: true },
      { id: 'v4', productId: '1', variantSku: 'CAM-OXF-001-S-BL', size: 'S', color: 'Blanco', barcode: 'RD20240004', stock: 2, minStock: 3, active: true },
      { id: 'v5', productId: '1', variantSku: 'CAM-OXF-001-M-BL', size: 'M', color: 'Blanco', barcode: 'RD20240005', stock: 0, minStock: 3, active: true },
    ],
    tags: ['camisa', 'oxford', 'algodón']
  },
  {
    id: '2',
    sku: 'PAN-JEA-002',
    ...
    variants: [
      { id: 'v6', productId: '2', variantSku: 'PAN-JEA-002-28-OS', size: '28', color: 'Oscuro', barcode: 'RD20240006', stock: 6, minStock: 2, active: true },
      { id: 'v7', productId: '2', variantSku: 'PAN-JEA-002-30-OS', size: '30', color: 'Oscuro', barcode: 'RD20240007', stock: 15, minStock: 2, active: true },
      { id: 'v8', productId: '2', variantSku: 'PAN-JEA-002-32-OS', size: '32', color: 'Oscuro', barcode: 'RD20240008', stock: 10, minStock: 2, active: true },
      { id: 'v9', productId: '2', variantSku: 'PAN-JEA-002-30-CL', size: '30', color: 'Claro', barcode: 'RD20240009', stock: 4, minStock: 2, active: true },
    ],
    tags: ['jeans', 'pantalón', 'mezclilla']
  },
  {
    id: '3',
    sku: 'VES-FLO-003',
    ...
    variants: [
      { id: 'v10', productId: '3', variantSku: 'VES-FLO-003-S-RO', size: 'S', color: 'Rosa', barcode: 'RD20240010', stock: 3, minStock: 2, active: true },
      { id: 'v11', productId: '3', variantSku: 'VES-FLO-003-M-RO', size: 'M', color: 'Rosa', barcode: 'RD20240011', stock: 7, minStock: 2, active: true },
      { id: 'v12', productId: '3', variantSku: 'VES-FLO-003-L-RO', size: 'L', color: 'Rosa', barcode: 'RD20240012', stock: 1, minStock: 2, active: true },
    ],
  ...
  },
  {
    ...
    variants: [
      { id: 'v13', productId: '4', variantSku: 'ACC-CIN-004-85-NE', size: '85cm', color: 'Negro', barcode: 'RD20240013', stock: 20, minStock: 5, active: true },
      { id: 'v14', productId: '4', variantSku: 'ACC-CIN-004-95-NE', size: '95cm', color: 'Negro', barcode: 'RD20240014', stock: 18, minStock: 5, active: true },
      { id: 'v15', productId: '4', variantSku: 'ACC-CIN-004-85-CA', size: '85cm', color: 'Café', barcode: 'RD20240015', stock: 12, minStock: 5, active: true },
    ],
  ...
  },
  {
    ...
    variants: [
      { id: 'v16', productId: '5', variantSku: 'CAL-TEN-005-25-BL', size: '25', color: 'Blanco', barcode: 'RD20240016', stock: 4, minStock: 2, active: true },
      { id: 'v17', productId: '5', variantSku: 'CAL-TEN-005-26-BL', size: '26', color: 'Blanco', barcode: 'RD20240017', stock: 6, minStock: 2, active: true },
      { id: 'v18', productId: '5', variantSku: 'CAL-TEN-005-27-BL', size: '27', color: 'Blanco', barcode: 'RD20240018', stock: 8, minStock: 2, active: true },
      { id: 'v19', productId: '5', variantSku: 'CAL-TEN-005-26-NE', size: '26', color: 'Negro', barcode: 'RD20240019', stock: 5, minStock: 2, active: true },
    ],
    tags: ['tenis', 'calzado', 'urbano']
  },
];
    ...
    (set, get) => ({
      ...
      completeSale: (paymentMethod, amountReceived, customerName, customerPhone, discount = 0) => {
        ...
        const newSale: Sale = {
          ...
          discount,
          total,
          currency: state.storeConfig.currency,
          exchangeRate: state.storeConfig.exchangeRate.USD_DOP,
          paymentMethod,
          amountReceived,
          change,
          status: 'completada',
      ...
      getCategories: () => {
        ...
        state.products.forEach(p => {
          if (p.categoryId) uniqueCategories.add(p.categoryId);
        });
